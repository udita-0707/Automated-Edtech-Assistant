...
class TextClassifier:
    ...
    def predict_detailed(self, student_answer, reference_answer):
        """
        Returns a dictionary with the label, confidence, internal scores,
        and a human-readable feedback string.
        """
        ...
        # Human-readable feedback for each grade class
        label_to_feedback = {
            0: "Great work! Your answer matches the reference closely.",
            1: "Your answer contradicts the expected response. Please review the concept.",
            2: "Your answer is partially correct or incomplete. Try to include key terms."
        }
        ...
        return {
            ...
            "feedback": label_to_feedback.get(int(pred_label),
                                               "Unable to determine feedback.")
        }
